...
filepath.frida <- ("G:/My Drive/Data/NumSample/plotData_EXP1/")
...
p2 <- ggplot() +
  ...
  scale_x_continuous(breaks = seq(1980,2130,20),expand=c(0,0))+
  scale_y_continuous(limits=c(0,1000),expand=c(0,0), breaks = c(0,200,400,600,800,1000))+
  theme(axis.text.x = element_text(size=12, angle = 90, family="sans"),
        axis.text.y = element_text(size=12, family="sans"),
        legend.text = element_text(size=11), 
        legend.background = element_blank(),
        ...
        legend.key.height = unit(.2,"cm"),
        legend.position = "inside",
        legend.position.inside = c(0.36,0.8),
        legend.key.spacing.x= unit(1,"cm"),
        legend.direction = "vertical",
        legend.box.just="left",
        legend.title=element_blank())
